...
$total_price = $price_check_car + $price_atc + $price_car_tax + $price_service + $price_tax_fine + $price_car_tax_owe;
...
?>
<h1>ผลการคำนวนค่าตรวจสภาพรถ พรบ. และ ทะเบียน</h1>
    ...
    <div class="col-md-12">
        ...
        <div class="text-center">
            <form action="index.php?menu=atc-new-addDB" method="post">
                ...
                <input type="button" value="กลับ" class="btn btn-danger" onclick="history.back()">
            </form>
        </div>
